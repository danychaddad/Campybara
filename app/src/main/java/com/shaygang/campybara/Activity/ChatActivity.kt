...
import com.shaygang.campybara.Class.ChatMessage
...
class ChatFromItem(val text : String, val receiverProfileUrl: String): Item<GroupieViewHolder>() {
    override fun bind(viewHolder: GroupieViewHolder, position: Int) {
        ...
        Picasso.get().load(receiverProfileUrl).into(viewHolder.itemView.findViewById<CircleImageView>(
            R.id.chatReceiverImageView
        ))
